...
import { Search, Building2, MapPin, GraduationCap, Globe } from 'lucide-react';
          ...
          {filtered.map((u, i) => {
            ...
            return (
              <motion.button
                ...
                className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-md hover:shadow-2xl border border-white/60 text-start transition-all"
              >
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-bold text-primary line-clamp-2 mb-1">{displayName}</h3>
